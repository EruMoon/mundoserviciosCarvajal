...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col items-center">
      {/* Header */}
      <header className="w-full bg-[#ffc800] text-black">
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row justify-between items-center py-4 px-4 sm:px-6 gap-4">
          <img src={msc} alt="Logo" className="h-22" />
          <div className="flex items-center flex-wrap justify-center gap-4">
            {!user ? (
              <>
                <Link
                  to="/register"
                  className="hidden sm:flex px-4 py-2 border-3 border-black rounded-full text-base hover:bg-[#02225f] hover:text-[#fff] transition"
                >
              ...
              <>
                ...
                {user.rol === "admin" && (
                  <Link
                    to="/admin"
                    className="px-4 py-2 border-2 border-black rounded-full text-base hover:bg-[#02225f] hover:text-[#fff] transition"
                  >
                    Panel
                  </Link>
                )}
            ...
            <div className="flex space-x-4">
              ...
              >
                <FaFacebook size={27} className="hover:text-[#02225f]" />
              </a>
              <a
                ...
                rel="noopener noreferrer"
              >
                <FaInstagram size={27} className="hover:text-[#02225f]" />
              </a>
              <a
                ...
                rel="noopener noreferrer"
              >
                <FaWhatsapp size={27} className="hover:text-[#02225f]" />
              </a>
            </div>
          </div>
        </div>
      ...
      {/* Footer */}
      <footer className="w-full bg-[#02225f] text-white py-8 px-4 mt-auto">
        ...
        <div className="mt-8 text-center text-sm text-gray-200 border-t border-white pt-4">
          ...
          <span className="font-semibold">MSC</span>. Todos los derechos
          reservados.
        </div>
      </footer>
    </div>
