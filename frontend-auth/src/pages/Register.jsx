    ...
    <div className="min-h-screen bg-blue-950 flex items-center justify-center px-4">
      <div className="max-w-md w-full bg-white p-8 rounded-lg shadow-md">
        ...
        <div className="flex justify-center mb-6">
          <img src={msc} alt="msc-logo" className="h-20" />
        </div>

        <h2 className="text-2xl font-bold text-center mb-6 text-[#ffc800]">Crear Cuenta</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="relative">
            ...
            />
            <FaUser className="absolute right-3 top-1/2 transform -translate-y-1/2 text-[#02225f]" />
          </div>
          ...
          <div className="relative">
            ...
            <div
              ...
              className="absolute right-3 top-1/2 transform -translate-y-1/2 text-[#02225f] cursor-pointer"
            >
        ...
        {/* Enlaces abajo */}
        <div className="mt-6 flex flex-col items-center gap-2 text-sm text-[#02225f]">
          <Link to="/login" className="font-medium hover:text-[#ffc800] transition">
            ¿Ya tienes cuenta? Inicia sesión
          </Link>
          <Link to="/" className="font-medium hover:text-[#ffc800] transition">
            Volver al inicio
          </Link>
        </div>
      </div>
